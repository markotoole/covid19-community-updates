...
@section('content')
    <div class="form-update-wrapper tint-gray">
        ...
        <div id="update-form" class="bg-white p-3">
            ...
            {!!Form::select('update_type', 'Update type')->required()->wrapperAttrs(['class'=> 'required'])->options(['Business' => 'Business', 'Community' => 'Community group'])->placeholder('Select one')!!}
            {!!Form::select('update_status', 'Update status')->required()->wrapperAttrs(['class'=> 'required'])->options(['' => 'Select from list..', 'new' => 'New', 'update' => 'Update'])->placeholder('Select one')!!}
            ...
            {!!Form::text('name', 'Business Name')->required()->wrapperAttrs(['class'=> 'required'])->wrapperAttrs(['id'=> 'name']) !!}
            ...
            {!!Form::checkbox('delivery', 'Offering Delivery')->wrapperAttrs(['class'=> 'pt-2 pb-2 mobile-checkbox', 'id' => 'delivery-inp']) !!}
            {!!Form::checkbox('service_offered', 'Offering Collection Service')->wrapperAttrs(['class'=> 'pt-2 pb-2 mobile-checkbox', 'id' => 'collection-inp']) !!}
